...
INCPATH       = -I/usr/lib/i386-linux-gnu/qt5/mkspecs/linux-g++ -I. -I/usr/include/qt5 -I/usr/include/qt5/QtMultimediaWidgets -I/usr/include/qt5/QtMultimedia -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -Wl,-rpath-link,/usr/lib/i386-linux-gnu
LIBS          = $(SUBLIBS) -lQt5MultimediaWidgets -L/usr/lib/i386-linux-gnu -lQt5Multimedia -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Project1.0.0/ && $(COPY_FILE) --parents resources.qrc .tmp/Project1.0.0/ && $(COPY_FILE) --parents view.h model.h controller.h header.h project.h videosurface.h playitem.h convertimagethread.h convertvideothread.h mysubwindows.h .tmp/Project1.0.0/ && $(COPY_FILE) --parents main.cpp view.cpp model.cpp controller.cpp project.cpp videosurface.cpp convertimagethread.cpp convertvideothread.cpp mysubwindows.cpp .tmp/Project1.0.0/ && $(COPY_FILE) --parents view.ui .tmp/Project1.0.0/ && (cd `dirname .tmp/Project1.0.0` && $(TAR) Project1.0.0.tar Project1.0.0 && $(COMPRESS) Project1.0.0.tar) && $(MOVE) `dirname .tmp/Project1.0.0`/Project1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Project1.0.0
